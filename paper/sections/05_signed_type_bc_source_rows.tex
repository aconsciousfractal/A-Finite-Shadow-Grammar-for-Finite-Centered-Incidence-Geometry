...
The signed source row comes from the companion signed Type-B/C dependency artifact.  It works with the finite shadow \(B_n\leq S_{2n}\), using the pair model for signed coordinates.  Standard Coxeter background for signed permutations is classical\cite{BjornerBrenti2005}.
